...
class TodosController {
	...
	constructor() {
	  ...
	  post = async (request: express.Request, response: express.Response, next: (arg0: any) => void) => {
	  ...
	  put = async (request: express.Request, response: express.Response, next: (arg0: any) => void) => {
		const body = request.body;
	  ...
	  delete= async (request: express.Request, response: express.Response, next: (arg0: any) => void) => {
		try
		{
